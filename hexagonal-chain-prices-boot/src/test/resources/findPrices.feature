Feature: the message can be retrieved
  ...
  Scenario: user makes call to POST sixth case
    When the user calls with product_id 35455 and application_date "2020-06-15T01:00:00.000Z"
  ...
  Scenario: user makes call to POST seventh case
